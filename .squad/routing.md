...
|-----------|----------|----------|
| Architecture, scope, decisions | Homer 🏗️ | System design, tech choices, trade-offs |
| Frontend, UI, game graphics | Bart ⚛️ | React components, canvas rendering, animations |
| Backend, APIs, multiplayer | Lisa 🔧 | WebSocket server, database, matchmaking |
| Code review | Homer 🏗️ | Review PRs, check quality, suggest improvements |
| Testing | Milhouse 🧪 | Write tests, find edge cases, verify fixes |
| Scope & priorities | Homer 🏗️ | What to build next, trade-offs, decisions |
